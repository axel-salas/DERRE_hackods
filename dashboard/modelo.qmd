...
::: {style="font-size: 1.15em; margin-left: 15px;"}
...
$$H_{t+1} = H_t \exp\left(r \left(1 - \frac{H_t}{K}\right) - a P_t\right) + \varepsilon_H$$

**Evolución de la Flota (Depredador):**
$$P_{t+1} = P_t \exp\left(f \left(1 - \frac{P_t}{C}\right)\right) + \varepsilon_P$$
...
dict(color="blue", value="1.15", icon="moisture")
...
dict(color="warning", value="0.04", icon="graph-up")

#| component: valuebox
#| title: "ε_H: Anomalías ambientales"
dict(color="info", value="± 0.26", icon="cloud-haze")
